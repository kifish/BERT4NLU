...
from src.model.BertForSeqClassification import BertForSeqClassifier
from src.dataset.dataset import PersonaDataset, CachedPersonaDataset
from src.dataset.dataset_utils.persona import Batcher, Batcher_v2
...
class Config():
    def __init__(self) -> None:
        ...
        self.model = BertForSeqClassifier 
        self.mode = 'run_all'
        ...
        # self.train_dataset_config['file_path'] = 'resource/data/personachat/train_self_original.txt'
        ...
        # self.val_dataset_config['file_path'] = 'resource/data/personachat/valid_self_original.txt'
        ...
        # self.test_dataset_config['file_path'] = 'resource/data/personachat/test_self_original.txt'
        self.test_dataset_config['file_path'] = 'resource/data/personachat/processed/processed_test_self_original.jsonl'

        
        # self.dataset = PersonaDataset  
        ...
        self.score_file = os.path.join(self.log_dir, '{}-scores.txt'.format(current_time))
        ...
        self.collect_fn = Batcher_v2(self.batcher_config)
